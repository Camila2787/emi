...
import FuseNavVerticalItemLogoutUser from './vertical/FuseNavVerticalItemLogoutUser';
...
import FuseNavHorizontalItemLogoutUser from './horizontal/FuseNavHorizontalItemLogoutUser';
...
function FuseNavigation(props)
{
    ...
    const verticalNav = (
        <List className={clsx("navigation whitespace-no-wrap", className)}>
            ...
            <React.Fragment key="logout-fragment">
                <Divider className="my-16" />
                <FuseNavVerticalItemLogoutUser />
            </React.Fragment>
        </List>
    );
    ...
    const horizontalNav = (
        <List className={clsx("navigation whitespace-no-wrap flex p-0", className)}>
            ...
            <React.Fragment key="logout-fragment">
                <FuseNavHorizontalItemLogoutUser />
            </React.Fragment>
        </List>
    );
