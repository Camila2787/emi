...
function AboutTab() {
    ...
    const getDateLastVersion = () => {
        return preval`module.exports = new Date().toLocaleString('es-CO',{timeZone: 'America/Bogota', hour12: false });`;
    };
                        ...
                        <CardContent>
                            ...
                            <div className="mb-24">
                                    <Typography className="font-bold mb-4 text-15">
                                        {T.translate("ProfilePage.AboutTab.general_information.emi_version")}
                                    </Typography>
                                 <Typography>{getDateLastVersion()}</Typography>
                            </div>
